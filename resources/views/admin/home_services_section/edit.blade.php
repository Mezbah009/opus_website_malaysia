...
<section class="content">
    <!-- Default box -->
    <form method="POST" action="{{ route('home_services_section.update', $section->id) }}"
        ...
        <div class="container-fluid">
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('home_services_section.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </div>
    </form>
